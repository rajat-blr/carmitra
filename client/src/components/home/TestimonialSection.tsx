    ...
    <div className="py-24 bg-gradient-to-br from-black to-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mt-12">
          <Link to="/reviews" className="bg-amber-800 text-white hover:bg-amber-700 px-8 py-3 rounded-xl font-medium transition-all duration-300 inline-flex items-center shadow-lg hover:shadow-xl">
...
const TestimonialCard: React.FC<TestimonialCardProps> = ({ testimonial }) => {
  return (
    <div className="bg-gray-800/80 backdrop-blur-md rounded-xl p-8 border border-gray-700 hover:bg-gray-800 transition-all duration-300">
      <div className="flex items-center gap-4 mb-6">
        <div className="w-16 h-16 rounded-full bg-amber-800 flex items-center justify-center text-xl font-bold">
      ...
      <svg className="h-10 w-10 text-amber-500/30 mb-4" fill="currentColor" viewBox="0 0 32 32">
